...
queries = [
    ("JOBE TX all", {"contributor_name": "JOBE", "contributor_state": "TX"}),
    ("JOBE 78728", {"contributor_name": "JOBE", "contributor_zip": "78728"}),
    ("VAN JOBE any state", {"contributor_name": "VAN JOBE"}),
    ("ROBERT SIMMONS 78762", {"contributor_name": "ROBERT SIMMONS", "contributor_zip": "78762"}),
    ("SIMMONS 78762 any", {"contributor_zip": "78762"}),
]
...
for label, extra in queries:
    ...
    for k in keys:
        try:
            ...
            print("  key err:", e)
            continue
        print("  TOTAL COUNT:", d.get('pagination', {}).get('count'))
