...
queries = [
    ("Melanie Walters TX", {"contributor_name": "Melanie Walters", "contributor_state": "TX"}),
    ("Alec Cohen TX", {"contributor_name": "Alec Cohen", "contributor_state": "TX"}),
    ("Cohen Alec AUSTIN", {"contributor_name": "Cohen", "contributor_city": "AUSTIN", "contributor_state": "TX", "contributor_occupation": "PROPERTY TAX CONSULTANT"}),
]
