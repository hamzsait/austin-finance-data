...
queries = [
    ("Courtney Hill AUSTIN", {"contributor_name": "Courtney Hill", "contributor_city": "AUSTIN", "contributor_state": "TX"}),
    ("employer GOOD SHEPHERD EPISCOPAL TX", {"contributor_employer": "GOOD SHEPHERD EPISCOPAL", "contributor_state": "TX"}),
    ("employer GSES TX", {"contributor_employer": "GSES", "contributor_state": "TX"}),
    ("Keith McAleer TX", {"contributor_name": "Keith McAleer", "contributor_state": "TX"}),
    ("Keith McAleer any", {"contributor_name": "Keith McAleer"}),
    ("employer LOGICAL POSITION", {"contributor_employer": "LOGICAL POSITION"}),
]
